...
public class ComConstant {
	...
	/** 字母列表 */
	public static final String[] LETTERS = new String[] { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L",
	...
	public static class LogPrefix {
		...
		public static final String COMIC_TENCENT_HOT_JOB = "[ COMIC - TENCENT HOT JOB ] ";
		public static final String COMIC_TENCENT_HOT_COMIC = "[ COMIC - TENCENT HOT COMIC ] ";
